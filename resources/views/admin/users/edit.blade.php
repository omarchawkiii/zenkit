            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="memberlist-form" class="needs-validation" action="{{ route('admin.users.update', $user) }}" method="post">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                        <div class=" row">
                                            <div class="col-lg-6">
                                                <div class="mb-3 ">
                                                    ...
                                                    <input type="text" class="form-control" name="name" value="{{ $user->name }}" id="name" placeholder="{{ __('message.Nom')}}" value="{{  $user->name }}" >
                                                    @error('name')
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="email" name="email" value="{{ $user->email }}" placeholder="{{ __('message.Email')}}" value="{{  $user->email }}" >
                                                    @error('email')
                                                        <div class="text-danger mt-1 ">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="iframe" name="iframe_link" placeholder="{{ __('message.iFrame')}}" value="{{  $user->iframe_link }}">
                                                    @error('iframe_link')
                                                        <div class="text-danger mt-1 ">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="input-light">
                                                    <select class="form-control" data-choices data-choices-search-false id="role" required  name="role">
                                                        <option value="user" @if($user->role == 'user') selected @endif>{{ __('message.User')}} </option>
                                                        <option value="admin" @if($user->role== 'admin') selected @endif>{{ __('message.Admin')}} </option>
